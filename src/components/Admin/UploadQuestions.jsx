...
const UploadQuestions = () => {
  ...
  const handleUpload = async (e) => {
    ...
    if (!categoryName.trim() || !file || !timer.trim()) {
      return setMessage(
        "Please enter a category name, timer, and select a CSV file."
      );
    }
  ...
  return (
    <div className="w-full max-w-3xl mx-auto my-6 bg-white rounded-xl shadow-lg p-8 overflow-visible">
