        ...
        <div className=" p-8 mb-6">
            ...
            <div className="flex items-center">
              ...
              <div className="ml-3">
                ...
                <p className="text-red-700">
                  Once you start the quiz, you cannot pause or restart it. Make sure you have a stable internet connection.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="bg-blue-50 rounded-xl p-6">
              ...
              <ul className="space-y-3 text-gray-700">
                ...
                <li className="flex items-start">
                  ...
                  <span>Use the question navigator to jump to any question quickly</span>
                </li>
                <li className="flex items-start">
                  ...
                  <span>You can change your answers anytime before submitting</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-green-50 rounded-xl p-6">
              ...
              <ul className="space-y-3 text-gray-700">
                ...
                <li className="flex items-start">
                  ...
                  <span>A warning will appear if you try to submit with unanswered questions</span>
                </li>
                <li className="flex items-start">
          ...
          <div className="border-2 border-gray-200 rounded-xl p-6 bg-gray-50">
            <div className="flex items-start space-x-3">
              ...
              />
              <label htmlFor="agreement" className="cursor-pointer text-gray-700 leading-relaxed">
                <span className="font-semibold text-gray-800">I acknowledge that:</span>
        ...
        <div className="text-center">
          ...
          {isAgreed && (
            <p className="mt-3 text-sm text-gray-600 animate-pulse">
              Click the button above to begin your quiz journey! 🚀
            </p>
          )}
        </div>
      </div>
